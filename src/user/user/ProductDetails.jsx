  ...
  const handleCartAction = (action, productId) => {
    ...
    switch(action) {
      case 'add':
        ...
        // Directly update the local state to avoid double counting from the useEffect
                        ...
                        {product.reviews > 0 ? (
                          <div className="space-y-4">
                            ...
                            <div className="mt-6 flex justify-center">
                              <button
                                className="px-6 py-2 text-center rounded border inline-flex items-center"
                                style={{ 
                          ...
                          <div className="text-center py-12">
                            ...
                            <motion.button
                              className="px-6 py-2 rounded border inline-flex items-center"
                              style={{ 
                                borderColor: colors.tertiary,
                                color: colors.tertiary
                              }}
